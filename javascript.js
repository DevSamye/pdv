...
let btnVenda = document.getElementById('venda');
let btnEstorno = document.getElementById('estorno');
let btnPlanilha = document.getElementById('export');

//eventos
btnVenda.addEventListener('click', venda, false);
...
function venda(e) {
    if (document.getElementById('mussarela').checked) {
        ...
        vendaMussarela = vendaMussarela + 25.50;
        ...
        vendaCalabresa = vendaCalabresa + 25.50;
